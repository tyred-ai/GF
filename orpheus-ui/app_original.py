...
async def generate_speech(request: TTSRequest):
    ...
    try:
        ...
        # Generate speech (remove extra parameters that might not be supported)
        ...
        print(f"\nGenerated {chunk_count} chunks, {len(audio_bytes)} bytes")
    ...
    try:
        ...
        while True:
            ...
            if data.get("type") == "generate":
                ...
                # Generate speech (simplified parameters)
                audio_generator = model.generate_speech(
                    prompt=text,
                    voice=voice
                )
